...
# train
python -m src.preprocess.dicom_to_dataframe --input /data/rsna2019/stage_1_train.csv --output ./cache/train_raw.pkl --imgdir /data/rsna2019/stage_1_train_images
...
# test
python -m src.preprocess.dicom_to_dataframe --input /data/rsna2019/stage_1_sample_submission.csv --output ./cache/test_raw.pkl --imgdir /data/rsna2019/stage_1_test_images
