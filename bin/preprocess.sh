...
# train
/data/anaconda3/bin/python -m src.preprocess.dicom_to_dataframe --input ./input/stage_1_train.csv --output ./cache/train_raw.pkl --imgdir ./input/stage_1_train_images
...
# test
/data/anaconda3/bin/python -m src.preprocess.dicom_to_dataframe --input ./input/stage_1_sample_submission.csv --output ./cache/test_raw.pkl --imgdir ./input/stage_1_test_images
